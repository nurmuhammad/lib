 ...
 */
public class SupertrendIndicatorPlus extends RecursiveCachedIndicator<Num> {
    ...
    public SupertrendIndicatorPlus(BarSeries series, int barCount, double factor) {
        this(series, barCount, factor, ATRIndicatorPlus.Input.MMA);
    }

    public SupertrendIndicatorPlus(Indicator<Num> indicator, int barCount, double factor) {
        this(indicator, barCount, factor, ATRIndicatorPlus.Input.MMA);
    }

    public SupertrendIndicatorPlus(BarSeries series, int barCount, double factor, ATRIndicatorPlus.Input atrInput) {
        this(new MedianPriceIndicator(series), barCount, factor, atrInput);
    }

    public SupertrendIndicatorPlus(Indicator<Num> indicator, int barCount, double factor, ATRIndicatorPlus.Input atrInput) {
        super(indicator);
